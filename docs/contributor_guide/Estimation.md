...
*	NOTE: this document has been copied from [the ONS MBS repository](https://github.com/ONSdigital/monthly-business-survey-results/blob/main/docs/source/project_docs_md/specifications/Estimation.md)
